...
Proof of concept of send mail from GAE from a Spring MVC project using 2 methods: <a href="https://cloud.google.com/appengine/docs/java/mail/" target="_blank">JavaMail</a> and <a href="https://cloud.google.com/appengine/docs/java/mail/sendgrid" target="_blank">SendGrid</a>.  

* [Front-end view](#front-end-view)
* [Project structure](#project-structure)
* [Java API code](#java-api-code)
* [SendGrid code](#sendgrid-code)

***
### Front-end view  
[[images/07_front_end.jpg]]  
![](https://antoniodiaz.github.io/images/spring_mvc/07_front_end.jpg)

***
### Project structure  
![](https://antoniodiaz.github.io/images/spring_mvc/07_structure.jpg)
